...
/// Struct representing the `~attach` decorator from its [RFC](<https://github.com/decentralized-identity/aries-rfcs/blob/main/concepts/0017-attachments/README.md>).
