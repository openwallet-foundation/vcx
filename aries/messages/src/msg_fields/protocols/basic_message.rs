//! Module containing the `basic message` protocol messages, as defined in the [RFC](<https://github.com/decentralized-identity/aries-rfcs/blob/main/features/0095-basic-message/README.md>).
