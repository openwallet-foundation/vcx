//! Module containing the `trust ping` protocol messages, as defined in the [RFC](<https://github.com/decentralized-identity/aries-rfcs/blob/main/features/0048-trust-ping/README.md>).
