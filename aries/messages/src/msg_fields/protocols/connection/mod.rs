//! Module containing the `connection` protocol messages, as defined in the [RFC](<https://github.com/decentralized-identity/aries-rfcs/blob/main/features/0160-connection-protocol/README.md>).
